...
validation-script syntax, package metadata, formatting, generated interfaces,
all supported targets, default/JS/native tests, coverage, native CLI smoke
behavior, and Mooncakes package validation.
