...
- [x] Split parser state, cursor helpers, and node-origin helpers into
      `parser/state.mbt`.
- [x] Split parser node-origin and source-location helpers into
...
- [x] Prepared `0.1.3` so the published package includes the sanitizer
      regression-file refactor and updated validation manifests.
- [x] Prepared `0.1.4` so the published package includes warning-free
      Debug-based test assertions.
...
- [x] Split parser scaffold and fragment-shell whitebox coverage into
...
- [x] Split public selector descendant-combinator regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector child-combinator regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector adjacent-sibling regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector general-sibling regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector first/last-child pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector only-child pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector empty pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector root pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector first/last-of-type pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector only-of-type pseudo regressions into
      `selector_public_regression_test.mbt`.
- [x] Split public selector nth-child pseudo regressions into
      `selector_public_regression_test.mbt`.
...
- [x] Split tree-builder nested foreign breakout reference regressions into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder body hidden input reference regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder MathML null text reference regressions into
      `treebuilder_fixtures_test.mbt`.
...
- [x] Split tree-builder hidden input in table regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder empty-stack foreign select regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder empty-stack nested select regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder empty-stack foreign table row regression into
      `treebuilder_fixtures_test.mbt`.
...
- [x] Split tree-builder table caption comment regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder select form-feed text regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder frameset trailing end regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder nested table in caption regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder table null-text regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder table direct-cell comment regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder after-head null regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder select stray-end EOF regression into
      `treebuilder_fixtures_test.mbt`.
- [x] Split tree-builder select parent-end text regression into
      `treebuilder_fixtures_test.mbt`.
...
- [x] Split pretty serializer raw/preformatted text-only regression into
      `serializer_public_regression_test.mbt`.
- [x] Split pretty serializer inline mixed-content regression into
      `serializer_public_regression_test.mbt`.
...
- [x] Split raw text end-tag boundary serializer regression into
      `serializer_public_regression_test.mbt`.
- [x] Split URL serialization context regression into
      `serializer_public_regression_test.mbt`.
...
- [x] Split parser simple element/text origin tracking regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser comment/doctype origin tracking regression into
      `parser_public_regression_test.mbt`.
- [x] Split parse_bytes origin tracking regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser foreign table recovery origin tracking regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split markdown code/list/blockquote rendering regression into
      `text_markdown_public_regression_test.mbt`.
- [x] Split markdown empty block and heading edge regressions into
      `text_markdown_public_regression_test.mbt`.
- [x] Split markdown nested list indentation regression into
      `text_markdown_public_regression_test.mbt`.
- [x] Split markdown orphan list item regression into
      `text_markdown_public_regression_test.mbt`.
...
- [x] Split parser self-closing solidus end-tag matching regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser malformed ordinary end-tag recovery regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split fragment parser literal text context regression into
      `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser html insertion-mode context regression into
      `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser table insertion-mode context regression into
      `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser table-section insertion-mode context regression
      into `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser table-row insertion-mode context regression into
      `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser table-cell insertion-mode context regression into
      `fragment_parser_public_regression_test.mbt`.
- [x] Split fragment parser caption insertion-mode context regression into
      `fragment_parser_public_regression_test.mbt`.
...
- [x] Split foreign content parser long-tail SVG name and font breakout
...
- [x] Split foreign content parser end-tag recovery regression into
      `foreign_content_public_regression_test.mbt`.
...
- [x] Split ruby annotation start exclusion parser regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser heading start recovery regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser mismatched heading end-tag regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser br end-tag recovery regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split parser strict-mode first-error regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser error collection position regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser tree-builder newline position regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser error category regression into
      `parser_public_regression_test.mbt`.
- [x] Split parse error value regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser bogus-comment null-character regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser abrupt-empty-comment regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser incorrectly-closed-comment regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser missing attribute value fixture regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser attribute-name fixture regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split parser missing quoted-attribute whitespace regression into
      `parser_public_regression_test.mbt`.
- [x] Split invalid self-closing start tag fixture regression into
      tokenizer and parser public regression tests.
- [x] Split start-tag solidus whitespace regression into tokenizer and
      parser public regression tests.
...
- [x] Split transport encoding override regression into
      `encoding_public_regression_test.mbt`.
- [x] Split UTF-8 BOM parse_bytes sniffing regression into
      `encoding_public_regression_test.mbt`.
- [x] Split direct meta charset prescan regression into
      `encoding_public_regression_test.mbt`.
- [x] Split meta prescan comment/non-meta skip regression into
      `encoding_public_regression_test.mbt`.
- [x] Split incomplete meta prescan construct regression into
      `encoding_public_regression_test.mbt`.
- [x] Split HTTP-equiv content charset prescan regression into
      `encoding_public_regression_test.mbt`.
- [x] Split UTF-16 BOM and explicit encoding regression into
      `encoding_public_regression_test.mbt`.
- [x] Split empty encoding label and malformed UTF-16 tail regression into
      `encoding_public_regression_test.mbt`.
...
- [x] Split tokenizer similarly named special end-tag regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer special-text EOF no-tree-error regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer malformed end-tag error regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer bogus-comment fixture regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer bogus-comment null-character regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer abrupt-empty-comment regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer incorrectly-closed-comment regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer selected EOF/null fixture regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer script escaped null EOF fixture regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer missing attribute value fixture regression into
      `tokenizer_public_regression_test.mbt`.
- [x] Split tokenizer unquoted attribute value fixture regression into
      `tokenizer_public_regression_test.mbt`.
...
- [x] Split parser special-text EOF regression and helper into
      `parser_public_regression_test.mbt`.
- [x] Split parser malformed special-text solidus end-tag regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split parser noscript scripting-mode regression into
      `parser_public_regression_test.mbt`.
- [x] Split parser disabled-scripting head noscript regression into
      `parser_public_regression_test.mbt`.
...
- [x] Split entity decoding upstream error regression into
      `entity_public_regression_test.mbt`.
- [x] Split numeric entity replacement/no-digit regression into
      `entity_public_regression_test.mbt`.
- [x] Split attribute entity upstream error regression into
      `entity_public_regression_test.mbt`.
- [x] Split attribute legacy entity continuation regression into
      `entity_public_regression_test.mbt`.
- [x] Split special-text entity upstream error regression into
      `entity_public_regression_test.mbt`.
...
- [x] Split document frameset post-token ignore regression into
      `document_frameset_public_regression_test.mbt`.
- [x] Split document frameset post-close reprocessing regression into
      `document_frameset_public_regression_test.mbt`.
...
- [x] Split table parser basic row group insertion regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser direct cell error regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser row-group closure regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser implied colgroup wrapper regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser column-group text handling regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser column-group non-col start closure regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser column-group non-colgroup end-tag closure regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser row-start table-structure closure regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser cell table-structure closure regression into
      `table_parser_public_regression_test.mbt`.
...
- [x] Split table parser nested table stack clearing regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser nested table start closure regression into
      `table_parser_public_regression_test.mbt`.
...
- [x] Split table parser foster-parented text origin regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser foster-parented start-tag regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser hidden input/form start regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser hidden input/form origin regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser style/script start regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser stray end-tag regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser outside-table structure-start regression into
      `table_parser_public_regression_test.mbt`.
- [x] Split table parser unfinished-table EOF regression into
      `table_parser_public_regression_test.mbt`.
...
- [x] Split select parser selectedcontent population regression into
      `select_parser_public_regression_test.mbt`.
- [x] Split select parser deep selectedcontent population regression into
      `select_parser_public_regression_test.mbt`.
...
- [x] Split template parser row-context foster-parenting regression into
      `template_parser_public_regression_test.mbt`.
...
- [x] Split template parser caption structural-start regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser caption end-recovery regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser ordinary body-start recovery regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser structural-start-after-caption recovery regression
      into `template_parser_public_regression_test.mbt`.
- [x] Split template parser caption end-tag recovery regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser column-group text handling regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser nested-template mode suspension regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser column-group origin tracking regression into
      `template_parser_public_regression_test.mbt`.
- [x] Split template parser column-group end-tag reprocessing regression into
      `template_parser_public_regression_test.mbt`.
...
- [x] Split document parser head-side whitespace regression into
      `document_parser_public_regression_test.mbt`.
- [x] Split document parser leading-comment doctype regression into
      `document_parser_public_regression_test.mbt`.
...
- [x] Split missing doctype identifier regression into
      `doctype_public_regression_test.mbt`.
- [x] Split missing doctype identifier quote regression into
      `doctype_public_regression_test.mbt`.
...
- [x] Split stray paragraph end-tag parser recovery regression into
      `parser_errors_public_regression_test.mbt`.
- [x] Split early ancestor end-tag parser recovery regression into
      `parser_errors_public_regression_test.mbt`.
- [x] Split mismatched heading end-tag parser recovery regression into
      `parser_errors_public_regression_test.mbt`.
- [x] Split recovered `br` end-tag parser regression into
      `parser_errors_public_regression_test.mbt`.
- [x] Split `image` start-tag parser regression into
      `parser_errors_public_regression_test.mbt`.
...
- [x] Split simple element/text origin regression into
      `parser_locations_public_regression_test.mbt`.
...
- [x] Split initial-newline special-text parser regression into
      `special_text_parser_public_regression_test.mbt`.
- [x] Split xmp/plaintext content parser regression into
      `special_text_parser_public_regression_test.mbt`.
- [x] Split special-text EOF parser regression and helper into
      `special_text_parser_public_regression_test.mbt`.
- [x] Split malformed special-text end-tag parser regression into
      `special_text_parser_public_regression_test.mbt`.
...
- [x] Split Unicode cursor parser regression into
...
- [x] Split noncharacter input-stream parser regression into
      `input_stream_parser_public_regression_test.mbt`.
- [x] Split deep tree-builder parser regression into
...
- [x] Split non-void self-closing tree-builder regression into
      `treebuilder_parser_public_regression_test.mbt`.
- [x] Split paragraph/block auto-close tree-builder regression into
      `treebuilder_parser_public_regression_test.mbt`.
...
- [x] Split HTML-namespace foreign root sanitizer regressions into
      `sanitize_foreign_content_public_regression_test.mbt`.
- [x] Split foreign mXSS stabilization sanitizer regressions into
      `sanitize_foreign_content_public_regression_test.mbt`.
...
- [x] Split CSS property, CSS URL, and CSS preset sanitizer regressions into
      `sanitize_css_public_regression_test.mbt`.
- [x] Split URL proxy sanitizer regressions into
      `sanitize_url_proxy_public_regression_test.mbt`.
...
- [x] Split missing-whitespace-after-quoted-attribute parser regression into
      `attribute_parser_public_regression_test.mbt`.
- [x] Split invalid self-closing start-tag parser regression into
      `attribute_parser_public_regression_test.mbt`.
- [x] Split start-tag solidus whitespace parser regression into
      `attribute_parser_public_regression_test.mbt`.
